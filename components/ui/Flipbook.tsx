...
export function Flipbook({ tone = "ink", width = 240, style, className = "" }: { tone?: "ink" | "paper"; width?: number; style?: CSSProperties; className?: string }) {
  const h = Math.round((width * 220) / 240);
  return (
    <div className={`rl-flip ${className}`} aria-hidden="true" style={{ width, height: h, ...style }}>
